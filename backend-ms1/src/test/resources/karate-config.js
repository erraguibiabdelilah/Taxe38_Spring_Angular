function fn() {
    ...
    config.adminUri = config.rootUrl + 'api/admin/';
        ...
        config.rueUrl = config.adminUri + 'rue/';
    config.localeUrl = config.adminUri + 'locale/';
    config.taxe38Url = config.adminUri + 'taxe38/';
    config.categorieLocaleUrl = config.adminUri + 'categorieLocale/';
    config.redevableUrl = config.adminUri + 'redevable/';
