package  ma.zs.univ.ws.facade.admin.communBean;
...
public class RedevableRestAdmin  extends AbstractController<Redevable, RedevableDto, RedevableCriteria, RedevableAdminService, RedevableConverter> {
    ...
    @Operation(summary = "Finds a redevable by nom")
    @GetMapping("nom/{nom}")
    public ResponseEntity<RedevableDto> findByNom(@PathVariable String nom) {
        return super.findByReferenceEntity(new Redevable(nom));
    }
